...
if (!$connectdb){
	...
	if(ISSET($_POST['search'])){
		...
		$query=mysql_query("SELECT * FROM cart WHERE date(date) BETWEEN '$date1' AND '$date2' ORDER by store_code, date, brand ASC") or die(mysqli_error());
...
<?php
		...
		</tr><a href='export6.php?date1=$date1&date2=$date2'>export</a>";
