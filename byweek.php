...
<body>
	...
	<div class="col-md-6 well" style="width:100%;">
		<h3 class="text-primary">All DSR by Week</h3>
		...
		<form class="form-inline" method="POST" action="">
			...
			<button class="btn btn-primary" name="search"><span class="glyphicon glyphicon-search"></span></button> <a href="byweek.php" type="button" class="btn btn-success"><span class = "glyphicon glyphicon-refresh"><span></a>
		</form>
		<br /><br />
